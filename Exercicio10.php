...
<html lang="pt-br">
  ...
  <body>
    ...
    <h1>10 - Valor do crédito</h1>
    <form action="" method="post">
    <table>
        <tr>
          <td><p>Saldo:</p></td>
          <td><input type="number" name="saldo" required/></td>
        </tr>
      </table>
    ...
    <div class="resposta">
      ...
      if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if($saldo>=201&&$saldo<=400){
          ...
          echo"
          <table>
          <tr><td>Saldo médio de 201-400</td></tr>
          <tr><td>Valor do crédito concedido: $saldo</td></tr>
          </table>";
        }
        elseif($saldo>=401&&$saldo<=600){
          $saldo=$saldo+($saldo*30/100);
          echo"      
          <table>
          <tr><td>Saldo médio de 401-600</td></tr>
          <tr><td>Valor do crédito concedido: $saldo</td></tr>
          </table>";
        }
        elseif($saldo>=601){      
          $saldo=$saldo+($saldo*40/100);
          echo"      
          <table>
          <tr><td>Saldo médio acima de 601</td></tr>
          <tr><td>Valor do crédito concedido: $saldo</td></tr>
          </table>";
        }
        else{
          ...
          echo"
          <table>
          <tr><td>Saldo médio de 0-200</td></tr>
          <tr><td>Valor do crédito concedido: $saldo</td></tr>
          </table>";
        }
      }
